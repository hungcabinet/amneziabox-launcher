...
Документ `SPECS/002-F-C-WIZARD_STATE/WIZARD_STATE_JSON_SCHEMA.md` требует обновления:
...
### 1. `SPECS/002-F-C-WIZARD_STATE/WIZARD_STATE_JSON_SCHEMA.md`
...
- **"Complete Example: Real-World Template"** — полностью переписать на новый формат (можно взять за основу `SPECS/003-F-C-UNIFIED_CONFIG_TEMPLATE/config_template.json`)
